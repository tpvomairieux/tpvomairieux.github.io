...
The data comes from Spotify, and was made accessible to R through the spotifyr package authored by Charlie Thompson, Josiah Parry, Donal Phipps, and Tom Wolff. The link to the dataset can be accessed here: [TidyTuesday Spotify Dataset](https://github.com/rfordatascience/tidytuesday/tree/main/data/2020/2020-01-21). From <https://open.spotify.com/>. It is possible to access the original dataset through [Spotify's Site](https://open.spotify.com/), where you can request the metadata of all artists and songs provided that you have an access token. 
